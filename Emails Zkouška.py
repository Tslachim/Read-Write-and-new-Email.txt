# Načtení dopisu 
with open("C:/Users/tslac/OneDrive/Plocha/Projekty/Read-Write-and-new-Email/general_letter.txt") as letter:
    letter_content = letter.read()

with open("C:/Users/tslac/OneDrive/Plocha/Projekty/Read-Write-and-new-Email/names.txt") as names:
